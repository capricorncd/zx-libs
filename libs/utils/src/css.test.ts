...
describe('css', () => {
  it('toCssValue', () => {
    ...
    expect(toCssValue('1rem -1')).toBe('1rem -1px')
    expect(toCssValue('1rem -1.5')).toBe('1rem -1.5px')
    expect(toCssValue('-0.8 -1.5')).toBe('-0.8px -1.5px')
    expect(toCssValue('-0.8 1em')).toBe('-0.8px 1em')
    expect(toCssValue('auto10 1em')).toBe('auto10 1em')
